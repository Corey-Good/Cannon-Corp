    ...
    static public Dictionary<int, Hashtable> info =
        new Dictionary<int, Hashtable>
        {
            { // Model 1, this is the base model tank
                0, new Hashtable()
                {
                    {"modelCameraOffset", new Vector3(0.0f, 5.25f, -8.0f)},
                    {"movementForce", 7.0f },
                    {"rotationSpeed", 30.0f },
                    {"healthPoints", 65.0f},
                    {"reloadSpeed", 2.0f},
            ...
            { // Model 2, this is the futuristic tank
                1, new Hashtable()
                {
                    {"modelCameraOffset", new Vector3(0.0f, .25f, -8.0f)},
                    {"movementForce", 10.0f },
                    {"rotationSpeed", 40.0f },
                    {"healthPoints", 55.0f},
                    {"reloadSpeed", 1.55f},
            ...
            { // Model 3, this is the catapult
                2, new Hashtable()
                {
                    {"modelCameraOffset", new Vector3(0.0f, 10.0f, -16.0f)},
                    {"movementForce", 5.0f },
                    {"rotationSpeed", 25.0f },
                    {"healthPoints", 90.0f},
                    {"reloadSpeed", 3.25f},
            ...
            { // Model 4, this is the Cartoon Tank
                3, new Hashtable()
                {
                    {"modelCameraOffset", new Vector3(0.0f, 10.0f, -17.0f)},
                    {"movementForce", 8.0f },
                    {"rotationSpeed", 35.0f },
                    {"healthPoints", 65.0f},
                    {"reloadSpeed", 1.85f},
            ...
            { // Model 5, this is the box tank
                4, new Hashtable()
                {
                    {"modelCameraOffset", new Vector3(0.0f, 2.0f, -4.0f)},
                    {"movementForce", 6.0f },
                    {"rotationSpeed", 30.0f },
                    {"healthPoints", 100.0f},
                    {"reloadSpeed", 2.4f},
